...
@section('title', 'Registrar Entrada (Almacén)')
...
<div class="card shadow-sm p-4">
    ...
    <h3 class="fw-bold mb-4" style="color:#c71585;">
        ➕ Registrar Nueva Entrada (Almacenista)
    </h3>
    ...
    <form action="{{ route('almacen.store') }}" method="POST">
        ...
        {{-- BOTONES --}}
        <a href="{{ route('almacen.dashboard') }}" class="btn btn-outline-dark mt-3">
            Cancelar
        </a>

        <button class="btn mt-3" style="background:#c71585; color:white;">
            Guardar Entrada
        </button>
